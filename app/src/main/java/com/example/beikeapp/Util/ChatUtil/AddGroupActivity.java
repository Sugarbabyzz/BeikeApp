...
public class AddGroupActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        rlContainerLayout = findViewById(R.id.rl_searched_group);
    ...
    public void searchGroup(View v){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    searchedGroup = EMClient.getInstance().groupManager().getGroupFromServer(etSearch.getText().toString());
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            rlContainerLayout.setVisibility(View.VISIBLE);
                            tvName.setText(searchedGroup.getGroupName());
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            searchedGroup = null;
                            rlContainerLayout.setVisibility(View.GONE);
    ...
    public void enterToDetails(View view){
        startActivity(new Intent(this, GroupSearchedDetailsActivity.class));
    }
